...
var PACKAGES = {
starter: {
name: 'Starter', price: 'KES 14,999', color: '#3a8fe8',
...
business: {
name: 'Business', price: 'KES 44,999', color: '#00e87a',
...
premium: {
name: 'Premium', price: 'KES 79,999', color: '#f5c842',
...
max: {
/* BUG FIX: this used to say "KES 200k–300k" here while the pricingcard on the page said "KES 150k–450k". Now consistent everywhere. */
name: 'MAX', price: 'KES 150k–450k', color: '#9b5de5',
...
btn.disabled = true;
var googleScriptUrl =
'https://script.google.com/macros/s/AKfycby6mIxaLXiOa0ZqxL93uf31KNtOeMVvJ3s2Bo4QzW_ dhAEeytwcyh5dv1DIpI13HLmZAg/exec';
try {

...
/* ── REAL 3D CUBE (Premium / MAX) — rendered with three.js, true WebGL
...
scene.add(cube);
var wireGeo = new THREE.EdgesGeometry(geometry);var wireMat = new THREE.LineBasicMaterial({ color: 0xffffff, transparent: true, opacity: 0.25 });
...
{ label: 'Restaurant Site', icon: '🍽', img: 'assets/sample-restaurant.jpg', alt: 'Restaurant dish
presentation' },{ label: 'E-Commerce Store', icon: '🛍', img: 'assets/sample-tech.jpg', alt: 'E-commerce shopping
concept' },
...
{ label: 'Fashion Brand', icon: '👗', img: 'assets/sample-fashion.jpg', alt: 'Fashion brand street
style' },
{ label: 'Tech Startup', icon: '💻', img: 'assets/sample-tech.jpg', alt: 'Tech startup product
showcase' },
];
...
a.appendChild(logoWrap);a.addEventListener('mouseenter', function () {
...
console.warn('VECTUZ: PAYMENT_METHODS not found — make sure payment-methods.js is
...
setTimeout(function () {animateSolve(loaderCube, function () {
...
features: [
{ title: 'Up to 2 Pages', desc: 'A clean homepage and one supporting page (e.g. About or
Contact). Perfect for simple business presence.' },
{ title: 'Mobile-Responsive Design', desc: 'Your site will look great on phones, tablets, and
desktops. Over 80% of Kenyan users browse on mobile.' },
{ title: 'Contact Form', desc: 'Customers can send you messages directly from the website. You
receive them in your email.' },
{ title: 'Social Media Links', desc: 'Connect your Instagram, Facebook, X, or WhatsApp so
visitors can follow and reach you instantly.' },
{ title: 'Google Maps Integration', desc: 'Show your exact business location on the site.
Customers can get directions with one tap.' },
{ title: '5-Day Delivery', desc: 'Your fully built website delivered and ready to launch within 5
business days of deposit and content submission.' },],
},
business: {
name: 'Business', price: 'KES 74,999', color: '#00e87a',
tagline: 'Sell online. Get paid. Grow faster.',
features: [
{ title: 'Up to 15 Pages', desc: 'Full multi-page website — Home, About, Services, Blog, Gallery,
Contact and more.' },
{ title: 'E-Commerce / Online Store', desc: 'Sell your products or services directly from your
website. Includes product listings, cart, and checkout flow.' },
{ title: 'M-Pesa & Card Checkout', desc: 'Customers can pay via M-Pesa STK push, debit/credit
cards, and mobile money — directly on your site.' },
{ title: 'Custom Animations', desc: 'Smooth scroll effects, hover interactions, and entrance
animations that make your site feel premium.' },
{ title: 'WhatsApp Chat Button', desc: 'A floating WhatsApp button so customers can message
you instantly from any page.' },
{ title: '7 Business Days Delivery', desc: 'Full e-commerce site delivered within 7 business days.
Speed without compromising quality.' },
{ title: '1 Month Free Support', desc: 'After launch, we handle bug fixes and minor updates for 30
...
features: [
{ title: 'Unlimited Pages', desc: 'No page limit. Build as large a website as your business
requires.' },
{ title: 'Full Custom Design System', desc: 'We build you a complete visual identity system —
fonts, colours, spacing, components.' },
{ title: 'Booking / Inventory Systems', desc: 'Let customers book appointments, reserve products,
or manage stock — automated and integrated.' },
{ title: 'Admin Dashboard', desc: 'A private dashboard where you manage orders, bookings,
content, and customers.' },
{ title: 'API Integrations', desc: 'Connect your site to external services — Google Calendar, SMS
gateways, accounting tools, CRMs, and more.' },
{ title: '3 Months Support', desc: 'Three full months of post-launch support. Bug fixes, updates,
and guidance included throughout.' },
{ title: 'Priority Delivery', desc: 'Your project jumps to the front of the queue. Faster turnaround
guaranteed.' },
],
},
max: {
/* BUG FIX: this used to say "KES 200k–300k" here while the pricingcard on the page said "KES 200k–600k". Now consistent everywhere. */
name: 'MAX', price: 'KES 200k–600k', color: '#9b5de5',
tagline: 'Total digital transformation.',
features: [
{ title: 'Custom Web Application', desc: 'A fully bespoke web app built around your business
processes — portals, dashboards, automation, workflows.' },
{ title: 'Android + iOS Mobile App', desc: "Your business in your customers' pockets. Native
mobile app published on Google Play and App Store." },
{ title: 'M-Pesa Daraja API Integration', desc: "Direct integration with Safaricom's Daraja API —
STK Push, C2B, B2C, and transaction callbacks." },
{ title: 'Inventory & CRM System', desc: 'Track your stock, manage customer relationships, and
automate follow-ups — all in one place.' },
{ title: 'WhatsApp Business API', desc: 'Automated WhatsApp messaging — order
confirmations, reminders, customer support bots.' },
{ title: 'Full Brand Identity Design', desc: 'Logo, colour palette, typography, business cards,
letterheads — your complete visual brand.' },
{ title: 'Staff Login & Roles System', desc: 'Multiple team members with different access levels —
admins, managers, editors, viewers.' },
{ title: 'SEO & Google Ranking Setup', desc: 'Technical SEO, keyword targeting, Google Search
Console setup, and sitemap submission.' },
{ title: 'Google Business Profile', desc: 'Full setup and optimisation of your Google Business
listing so customers find you on Maps.' },
{ title: 'Analytics & Reporting Dashboard', desc: 'Real-time data on visitors, sales, conversions,
and performance — all in a clean dashboard.' },
{ title: 'Staff Training', desc: 'We train your team to use and manage the system confidently.
Includes documentation.' },
{ title: '6 Months Dedicated Support', desc: 'Six months of priority support — your dedicated
...
features: [
{ title: 'Full Walkthrough', desc: 'We go through your existing website page by page, the way a
real customer would.' },
{ title: 'Mock-Up Analysis', desc: 'We put together a quick visual mock-up showing exactly how a
few key improvements would look.' },
{ title: 'Conversion Trouble Spots', desc: 'We flag the specific things most likely costing you
customers — slow load times, confusing navigation, weak calls-to-action, and more.' },
{ title: 'No Obligation', desc: 'You keep the feedback either way. If you want us to build the
improvements, great — if not, that\'s fine too.' },
],
},};
/* ── PACKAGE MODAL ── */
...
face.style.transition = 'transform 0.9s cubic-bezier(.25,1,.3,1), opacity 0.9s
...
function closeModal() {
loopActive = false;clearEnergyTimers();
...
var originalText = btn.textContent;btn.textContent = 'Sending...';
btn.disabled = true;
var googleScriptUrl =
'https://script.google.com/macros/s/AKfycby6mIxaLXiOa0ZqxL93uf31KNtOeMVvJ3s2Bo4QzW_
dhAEeytwcyh5dv1DIpI13HLmZAg/exec';
try {
...
if (!btn) return;
var icon = btn.querySelector('.toggle-icon');function getCurrentTheme() {

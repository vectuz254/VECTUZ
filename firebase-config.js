...
other clients' data. This locks each client to their own document, and
also stops clients from approving their own accounts (see the "approved"
field used by portal-auth.js).
